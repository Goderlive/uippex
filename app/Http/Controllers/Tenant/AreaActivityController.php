...
class AreaActivityController extends Controller
{
    ...
    public function store(Request $request, $areaId)
    {
        ...
        $validated = $request->validate([
            ...
            'schedule.jan_programmed' => 'nullable|integer|min:0',
            'schedule.feb_programmed' => 'nullable|integer|min:0',
            'schedule.mar_programmed' => 'nullable|integer|min:0',
            'schedule.apr_programmed' => 'nullable|integer|min:0',
            'schedule.may_programmed' => 'nullable|integer|min:0',
            'schedule.jun_programmed' => 'nullable|integer|min:0',
            'schedule.jul_programmed' => 'nullable|integer|min:0',
            'schedule.aug_programmed' => 'nullable|integer|min:0',
            'schedule.sep_programmed' => 'nullable|integer|min:0',
            'schedule.oct_programmed' => 'nullable|integer|min:0',
            'schedule.nov_programmed' => 'nullable|integer|min:0',
            'schedule.dec_programmed' => 'nullable|integer|min:0',
        ]);
