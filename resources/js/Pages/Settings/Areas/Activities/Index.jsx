...
export default function ActivitiesIndex({ auth, area, activities, themes, flash }) {
    ...
    const startEditing = (activity) => {
        ...
        setEditData({
            ...
            schedule: {
                jan_programmed: s.jan_programmed || 0,
                feb_programmed: s.feb_programmed || 0,
                mar_programmed: s.mar_programmed || 0,
                apr_programmed: s.apr_programmed || 0,
                may_programmed: s.may_programmed || 0,
                jun_programmed: s.jun_programmed || 0,
                jul_programmed: s.jul_programmed || 0,
                aug_programmed: s.aug_programmed || 0,
                sep_programmed: s.sep_programmed || 0,
                oct_programmed: s.oct_programmed || 0,
                nov_programmed: s.nov_programmed || 0,
                dec_programmed: s.dec_programmed || 0,
            }
        });
    };
